...
def generate_over_a_t1_dataset(model, tokenizer, dataset, base_model, task, sample_type_name, nb_sample, loss_computation, config):
    ...
    print("let's go")
    #for the two first elements in the dataset
    for index,sample in enumerate(dataset[:2]):
        print(index)
    ...
    for base_model in base_models:
        ...
        for task in tasks:
            ...
            for sample_type in sample_types:
                ...
                testing_dataset_with_inferences_path = f"./output_rerun_task-3_check/{base_model_name}/{task}/{sample_type_name}/test_with_inferences.json"
