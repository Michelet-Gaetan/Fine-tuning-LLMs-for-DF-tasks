...
def generate_over_a_t1_dataset(model, tokenizer, dataset, base_model, task, sample_type_name):
    ...
    print("let's go")
    #for the two first elements of the dataset
    ...
    for base_model in base_models:
        ...
        for task in tasks:
            ...
            for sample_type in sample_types:
                ...
                testing_dataset_with_inferences_path = f"./output_rerun_task-3_base_check/{base_model_name}/{task}/{sample_type_name}/test_with_inferences.json"
