...
if __name__=="__main__":
    ...
    #list containing the models that already inferred in a previous attempt
    skip_list = ["GaetanMichelet/Llama-31-8B_task-2_60-samples_config-1",
                 "GaetanMichelet/Llama-31-8B_task-2_60-samples_config-2"]

    #base_models = ["meta-llama/Meta-Llama-3.1-8B-Instruct","google/gemma-2-2b-it","mistralai/Mistral-7B-Instruct-v0.3"]
    base_models = ["meta-llama/Meta-Llama-3.1-8B-Instruct"]
    tasks = ["task-2"]
    ...
    for base_model in base_models:
        ...
        for task in tasks:
            ...
            for sample_type in sample_types:
                ...
                testing_dataset_with_inferences_path = f"./output/{base_model_name}/{task}/{sample_type_name}/test_with_inferences.json"
