...
for model in "${models[@]}"; do
    ...
    for type in "${types[@]}"; do
        ...
        repo_model="./recipes/custom/real_full${type_written}/${model}"
        ...
        for task in "${tasks[@]}"; do
            ...
            for sample in "${samples[@]}"; do
                ...
                for config in "${configs[@]}"; do
                    ...
                    name_combo="${model}_${task}_${sample}_${config}_full${type_written}"

                    repo_file="./recipes/custom/real_full${type_written}/${model}/${model}_${task}_${sample}_${config}_full${type_written}"
