...
for model in "${models[@]}"; do
    ...
    repo_model="./recipes/custom/real_full_auto/${model}"
    ...
    for task in "${tasks[@]}"; do
        ...
        for sample in "${samples[@]}"; do
            ...
            for config in "${configs[@]}"; do
                ...
                name_combo="${model}_${task}_${sample}_${config}_full_auto"

                repo_file="./recipes/custom/real_full_auto/${model}/${model}_${task}_${sample}_${config}_full_auto"
