...
def main():
    ...
    for task in tasks:
        for creation in creations:
            ...
            test_output = f"./output_prompt_generation/rerun_task-3/{task}/{creation}/test.json"
            
            #setup the ouput path for each fine-tuning testing dataset
            test_output_check = f"../../data/testing_dataset/rerun_task-3/{task}/{creation}/test.json"
...
if __name__=="__main__":
    #first run normal
    #second run just for task-3 here the seed is reset to 1000 between automatic and manual
    main()